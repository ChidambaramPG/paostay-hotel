            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <i data-feather="radio" class="tx-primary tx-12"></i> New Amenity
                    </h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group mg-b-10">
                            ...
                            <input type="text" class="form-control" placeholder="Swimming Pool">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="hideModal">Cancel</button>
                    <button type="button" class="btn btn-primary">Add Amenity</button>
                </div>
            </div>
          </div>
        </div>
